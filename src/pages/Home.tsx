...
const Hero: React.FC = () => (
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <p className="text-xs tracking-widest text-violet-300/90 uppercase">Fullstack JavaScript</p>
      <h1 className="mt-3 text-4xl sm:text-6xl font-extrabold leading-tight">Robin Jörgensen</h1>
      <p className="mt-5 text-zinc-300 max-w-2xl">Rblablalbalb</p>
    ...
    return (
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-zinc-400 max-w-2xl">Etblabla.</p>
        </div>
